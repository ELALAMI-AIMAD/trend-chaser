...
const EVENTS: CalendarEventDef[] = [
  ...
  // JUNE
  { name: "Pride Month",           date: new Date(Date.UTC(2026, 5,  1)), region: "US", category: "awareness",   recurs: true },
  ...
  // OCTOBER
  { name: "Breast Cancer Awareness Month", date: new Date(Date.UTC(2026, 9,  1)), region: "US", category: "awareness", recurs: true },
